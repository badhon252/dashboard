  ...
  return (
    <div>
      <div className="input-container mx-5 my-3">
        ...
        <DonutInput inputValue={inputValue1} handleChange={handleChange1} text={} />
        <DonutInput inputValue={inputValue2} handleChange={handleChange2} text={} />
        <DonutInput inputValue={inputValue3} handleChange={handleChange3} text={} />
        <DonutInput inputValue={inputValue4} handleChange={handleChange4} text={} />
        <DonutInput inputValue={inputValue5} handleChange={handleChange5} text={} />
        <DonutInput inputValue={inputValue6} handleChange={handleChange6} text={} />
        <DonutInput inputValue={inputValue7} handleChange={handleChange7} text={} />
