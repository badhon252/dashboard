    ...
    if (active && payload && payload.length) {
      return (
        <div className={Classes.customTooltip}>
          <p className="date_label"> {label + " Jan 2023"}</p>

          <div className="d-flex">
            <div className={Classes.tooltipAllowed}>
              <p className="label">
                <span className="indicator allowed_ind"></span> Allowed
              </p>
              <p className="label allowedValue">
                <span className="indicator allowed_ind"></span>
                {`${payload[0].value}`}
              </p>
            </div>
            ...
            <div className="tooltip-blocked">
              <p className="label my-0">
                <span className="indicator blocked_ind"></span> Blocked
              </p>
              <p className="label blocked-value">
                <span className="indicator blocked_ind"></span>
                {`${payload[1].value}`}
              </p>
            </div>
          </div>
