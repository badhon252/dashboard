  ...
  return (
    <div>
      <div className="input-container mx-5 my-3">
        ...
        <DonutInput inputValue={inputValue1} handleChange={handleChange1} text={Command and Control Host} />
        <DonutInput inputValue={inputValue2} handleChange={handleChange2} text={Anonymization Service} />
        <DonutInput inputValue={inputValue3} handleChange={handleChange3} text={Compromised C2 Host} />
        <DonutInput inputValue={inputValue4} handleChange={handleChange4} text={Bad Nameserver IP} />
        <DonutInput inputValue={inputValue5} handleChange={handleChange5} text={Cryptocurrency} />
        <DonutInput inputValue={inputValue6} handleChange={handleChange6} text={Botnet Host} />
        <DonutInput inputValue={inputValue7} handleChange={handleChange7} text={Bogons} />
