  ...
  return (
    <div>
      <div className="input-container mx-5 my-3">
        ...
        <value={inputValue2} onChange={handleChange2} />
        <value={inputValue3} onChange={handleChange3} />
        <value={inputValue4} onChange={handleChange4} />
        <value={inputValue5} onChange={handleChange5} />
        <value={inputValue6} onChange={handleChange6} />
        <value={inputValue7} onChange={handleChange7} />
